...
const Container: FC<{ className?: string; children: ReactNode }> = ({
  ...
  return (
    <div
      className={cn(
        'w-full h-screen mx-auto my-auto p-9 flex flex-col inset-shadow-lg  relative overflow-clip bg-wheel bg-center',
        !isMobile &&
          'max-w-[420px] max-h-[839px] rounded-[46px] shadow-soft-xl',
        className
      )}
      {...props}
    >
