...
const Container: FC<{ className?: string; children: ReactNode }> = ({
  ...
  return (
    <div
      className={cn(
        'w-full mx-auto p-9 flex-1 flex flex-col inset-shadow-lg  relative overflow-hidden bg-wheel bg-center',
        !isMobile &&
          'max-w-[420px] rounded-[46px] shadow-soft-xl aspect-[1/2] w-full h-full overflow-clip',
        className
      )}
      {...props}
    >
